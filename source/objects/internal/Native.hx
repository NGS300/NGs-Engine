...
class Native {
	...
	public static function fix(Width:Int, Height:Int):Void {
		...
		if (display != null) {
			...
			@:privateAccess Application.current.window.width = Std.int(Width * dpiScale);
			@:privateAccess Application.current.window.height = Std.int(Height * dpiScale);
